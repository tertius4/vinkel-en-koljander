...
<div class="min-h-screen bg-linear-to-br from-orange-50 to-amber-50 py-8 px-4">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8">
      ...
      <div class="space-y-8">
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="flex items-center space-x-4">
                <label for="foto" class="flex items-center justify-center w-32 h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-orange-400 hover:bg-orange-50 transition-colors">
        ...
        <div class="bg-gray-50 rounded-xl p-6">
          ...
          <div class="flex flex-wrap gap-2 mb-4">
            {#each resep.kategorieë as kategorie (kategorie)}
              <div class="inline-flex items-center bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm font-medium group hover:bg-orange-200 transition-colors">
                {kategorie}
                <button
        ...
        <div class="bg-gray-50 rounded-xl p-6">
          ...
          <!-- New Step Form -->
          <div class="bg-white border-2 border-dashed border-orange-200 rounded-lg p-6">
                  ...
                  {#each nuwe_stap.bestanddele as bestanddeel, index}
                    <div class="flex items-center gap-2">
                      <div class="grid grid-cols-4 gap-2 flex-1 text-sm">
                        <div class="bg-orange-50 px-3 py-2 rounded border">{bestanddeel.naam}</div>
                        <div class="bg-orange-50 px-3 py-2 rounded border">{bestanddeel.eenheid}</div>
                        <div class="bg-orange-50 px-3 py-2 rounded border">{bestanddeel.hoeveelheid}</div>
                        <div class="bg-orange-50 px-3 py-2 rounded border">{bestanddeel.nota}</div>
                      </div>
                      <button
                        class="text-red-500 hover:text-red-700 p-1 rounded hover:bg-red-50 transition-colors"
                        onclick={() => {
            ...
            <div class="bg-orange-50 rounded-lg p-4 mb-4">
              <h4 class="text-sm font-medium text-gray-700 mb-3">Voeg bestanddeel by:</h4>
              <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                <input
                  class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
                  type="text"
                  placeholder="Naam"
        ...
        <div class="flex justify-center pt-4">
          <button
            type="button"
            onclick={save}
            class="bg-linear-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white px-8 py-4 rounded-xl transition-all duration-200 font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
            Stoor Resep
          </button>
        </div>
